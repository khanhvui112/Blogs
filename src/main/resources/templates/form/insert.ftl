...
<div class="content-wrap">
    <div class="main">
        ...
        <!-- /# row -->
        <form name="category" action="/category/insert" method="POST" style="
                margin: 0 30%;
            ">
            ...
            <div class="form-group">
                ...
                <select
                    ...
                    <option selected value="${(category.name)!'true'}">TRUE</option>
                    <option value="${(category.name)!'false'}">FALSE</option>
